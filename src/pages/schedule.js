    ...
    return (
        <Layout>
            <div className="flex justify-center mt-16">
                <h2 className="z-10 mt-40 mb-16 text-4xl font-bold lg:mb-40 md:mb-24 sm:mb-20 xl:text-8xl lg:text-7xl md:text-6xl sm:text-5xl gradienta"><span>Schedule a call with us</span></h2>
            </div>

            <div className="flex flex-col md:flex-row">
                <div className="flex flex-row w-full md:w-1/2">
                    <div className="w-full text-center md:w-1/2 md:text-left">
                        <h3 className="text-4xl font-bold leading-10 tracking-tight text-white"><span className="gradienta">Email us:</span></h3>
                        <p><a href='&#109;&#97;&#105;l&#116;o&#58;inf&#111;&#64;%&#55;0%&#54;&#53;%74al&#46;p%7&#55;'>&#105;nfo&#64;peta&#108;&#46;pw</a>&nbsp;<svg className="inline-block w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg></p>
                    </div>
                    <div className="w-full text-center md:w-1/2 md:text-left">
                        <h3 className="text-4xl font-bold leading-10 tracking-tight text-white"><span className="gradienta">Call us:</span></h3>
                        <p>+62 81 999 527 649</p>
                    </div>
                </div>
                <div className="w-full space-y-4 md:w-1/2 md:ml-10">
                    <p className="mt-12 leading-loose text-center md:text-left sm:mt-16 md:mt-0">Fill in our form and we'll get straight back to you or at a time convenient for you. Please let us know if you would like us to call or email you, or we can chat online.</p>
                    <p className="text-center md:text-left">We look forward to hearing from you.</p>
                </div>
            </div>
