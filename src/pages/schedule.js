    ...
    return (
        <Layout>
            <div className="flex justify-center mt-16">
                <h2 className="z-10 my-40 font-bold text-8xl gradienta"><span>Schedule a call with us</span></h2>
            </div>
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full space-y-4 md:w-1/2 md:ml-10">
                    <p className="leading-loose">Fill in our form and we'll get straight back to you or at a time convenient for you. Please let us know if you would like us to call or email you, or we can chat online.</p>
