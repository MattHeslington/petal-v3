    ...
    return (
        ...
        <Layout>
            ...
            <div className="flex flex-col items-center justify-center mt-56 mb-40 space-y-6">
                <h2 className="z-10 text-5xl font-bold sm:text-6xl md:text-6xl xl:text-8xl gradienta"><span>Working with Petal</span></h2>
                <p className="text-base font-bold tracking-tight text-center xl:text-2xl lg:text-xl md:text-lg md:w-9/12">When you decide to work with Petal we like to include the following steps in our build schedule with you. Every project is different, and we are more than happy to adapt and change for all of our customers</p>
            </div>
            ...
            <div className="pb-32">
                ...
                <div className="flex flex-col items-center justify-center w-full space-y-6 md:flex-row md:space-y-0">
                    ...
                    <div className="w-8/12 md:ml-10 md:w-5/12">
                        <p className="text-center md:text-left">We have curiosity, and a great passion to please. We believe to make great products we must truly listen to what  our clients want. Only be really understanding our client’s needs will we be able to provide what they truly want.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col-reverse items-center w-full space-y-6 md:flex-row md:space-y-0">
                    <div className="w-8/12 mt-6 md:w-5/12 md:mr-10 md:mt-0">
                        <p className="text-center md:text-right">We believe in transparency and will provide you with an itemised quote, showing every aspect of the build of your website, where you can pick and choose the which features you would like included with your new site, and maybe suggest some new ones.</p>
                    </div>
                    ...
                    <div className="flex items-center justify-center w-full md:ml-10 md:justify-start md:w-5/12">
                        <h3 className="text-4xl font-bold tracking-tight md:text-left text:center leading-0 gradienta">
                            <div className="inline-block">
                ...
                <div className="flex flex-col items-center justify-center w-full space-y-6 md:flex-row md:space-y-0">
                    ...
                    <div className="w-8/12 md:ml-10 md:w-5/12">
                        <p className="text-center md:text-left">We’ll provide you with a number of graphical mockups of each area of the website, which can then be iterated over through conversation and consideration until we have the best possible new design for your new website. </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center w-full space-y-6 md:flex-row md:space-y-0">
                    ...
                    <div className="w-8/12 md:ml-10 md:w-5/12">
                        <p className="text-center md:text-left">When you’re happy with with your interactive mockups, we then begin the all-important crafting of your website, using the best possible technologies for the requirements at hand, ensuring you have a new website which will be your pride and joy.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col-reverse items-center w-full space-y-6 md:flex-row md:space-y-0">
                    <div className="w-8/12 md:w-5/12 md:mr-10">
                        <p className="mt-6 text-center md:text-right md:mt-0">There’s no real substitute for getting the feel for how your website looks and feels in real-life.  While we know you'll love your new site, there's no substitute for user-testing in the wild and we'll make and necessary changes based on user-feedback.</p>
                    </div>
                    <div className="flex justify-center w-2/12 line">
                        <div className="z-20 flex">
