        ...
        <div className="flex flex-row items-center justify-between h-24">
            ...
            <div>
                <ul className="flex flex-row items-center space-x-4 sm:space-x-12">
                    ...
                    <li className="text-xs font-light sm:text-sm">
                        <Link to="/schedule">
                            <Link to="/schedule" data-content="Working with Petal" className="font-sans highlight sm:hidden">Contact us</Link>
                            <button className="items-center hidden px-4 py-2 font-sans text-sm font-light border border-white rounded-full sm:flex sm:px-5 sm:py-3 bg-footerBG">
                                Schedule a Call&nbsp;
                                <svg className="w-5 h-5 sm:inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" /></svg>
                            </button>
                        </Link>
                    </li>
