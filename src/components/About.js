    ...
    return (
        <div className="flex flex-col items-center h-screen mb-64 lg:flex-row sm:mb-48">
            <div className="flex flex-col justify-center w-full h-screen px-12 lg:w-1/2">
                <h2 className="font-sans font-bold leading-snug tracking-tight text-center text-white sm:text-5xl lg:text-left">You're in <span className="gradienta">great hands</span>.</h2>
